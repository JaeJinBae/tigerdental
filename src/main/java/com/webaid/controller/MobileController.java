...
public class MobileController {
	...
	public String menu06_01read(int no, @ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
	...
	public String menu06_02read(int no, @ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
	...
	public String menu06_03(@ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
	...
	public String menu06_04(@ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
	...
	public String menu06_04read(int no, @ModelAttribute("cri") SearchCriteria cri, Model model) throws Exception {
	...
	public String menu06_05(@ModelAttribute("cri") SearchCriteria cri, Model model) {
	...
	public String menu06_05writePost(MultipartHttpServletRequest mtfReq, Model model){
		...
		return "redirect:/m/menu06_05";
	}
	
	@RequestMapping(value = "/menu06_05update", method = RequestMethod.GET)
	public String menu06_05update(int no, @ModelAttribute("cri") SearchCriteria cri, Model model, HttpServletRequest req) {
