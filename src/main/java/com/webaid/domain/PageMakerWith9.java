...
public class PageMakerWith9 {
	...
	private Criteria9 cri;// 현재 페이지 번호를 알아야 시작과 끝을 구할 수 있음
	...
	public Criteria9 getCri() {
		return cri;
	}

	public void setCri(Criteria9 cri) {
		this.cri = cri;
	}
	...
	public String toString() {
		return "PageMakerWith9 [totalCount=" + totalCount + ", startPage=" + startPage + ", endPage=" + endPage + ", prev="
	...
	public String makeSearch(int page){
		UriComponents uriComponents=UriComponentsBuilder.newInstance().queryParam("page", page)
																		...
																		.queryParam("searchType", ((SearchCriteria9)cri).getSearchType())
																		.queryParam("keyword", ((SearchCriteria9)cri).getKeyword()).build();
