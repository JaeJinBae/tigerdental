...
public class PageMakerWith12 {
	...
	private Criteria12 cri;// 현재 페이지 번호를 알아야 시작과 끝을 구할 수 있음
	...
	public Criteria12 getCri() {
		return cri;
	}

	public void setCri(Criteria12 cri) {
		this.cri = cri;
	}
	...
	public void setFinalPage(int finalPage) {
		...
		this.finalPage = (int) Math.ceil(totalCount/10);
	}

	@Override
	public String toString() {
		return "PageMakerWith12 [totalCount=" + totalCount + ", startPage=" + startPage + ", endPage=" + endPage + ", prev="
	...
	public String makeSearch(int page){
		UriComponents uriComponents=UriComponentsBuilder.newInstance().queryParam("page", page)
																		...
																		.queryParam("searchType", ((SearchCriteria12)cri).getSearchType())
																		.queryParam("keyword", ((SearchCriteria12)cri).getKeyword()).build();
