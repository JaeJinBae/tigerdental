...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<!-- 타이틀 -->
		<div class="member-title">회원정보수정</div>
			...
			<div class="join-form">
				...
				<form name="member" id="member" method="post" enctype="multipart/form-data">
					...
					<div class="join-form-list">
						...
						<input type="text" id="m_name" name="m_name" value="${item.name}" data-name="이름" required="">
					...
					<div class="join-form-list">
						<label for="m_newpass">새비밀번호<i class="required">*</i></label>
						<input type="password" id="m_newpass" name="m_newpass" maxlength="13" data-name="새비밀번호">
					</div>
					<div class="join-form-list">
					...
					<div class="join-form-list">
						...
						<div>
							<input type="radio" name="m_solar" id="m_solar1" value="1" checked="checked" data-name="양력음력" required=""> <label for="m_solar1"><i></i>양력</label>&nbsp;&nbsp;&nbsp;<input type="radio" name="m_solar" id="m_solar2" value="2" data-name="양력음력" required=""> <label for="m_solar2"><i></i>음력</label>&nbsp;&nbsp;&nbsp;		</div>
					</div>
					<div class="join-form-list">
						...
						<span>-</span>
						<input type="text" id="phone2" name="phone2" maxlength="4" value="2837" data-name="휴대전화"><span>-</span>
						<input type="text" id="phone3" name="phone3" maxlength="4" value="7425" data-name="휴대전화">
					</div>
					<div class="join-form-list">
						<label for="m_sex1">성별</label>
						<div>
							<input type="radio" name="m_sex" id="m_sex1" value="M" checked="checked" data-name="성별" required=""> <label for="m_sex1"><i></i>남자</label>&nbsp;&nbsp;&nbsp;
					...
					<div class="join-form-list">
						...
						<input type="text" name="m_email1" id="m_email1" maxlength="13" value="bjj7425" data-name="이메일" required=""><span>@</span>
						<input type="text" name="m_email2" id="m_email2" maxlength="13" value="naver.com" data-name="이메일" required="">
					...
					<div class="join-form-list">
						...
						<input type="text" id="m_addr2" name="m_addr2" value="${item.addr}" data-name="상세주소">
					</div>
					</form>
				<!-- form end -->
		...
		<div class="btn-group-center">
			<div class="inner">
				<div class="brick">
					...
					<button type="button" class="btn btn-cancel" onclick="location.href='${pageContext.request.contextPath}/withdraw';">회원탈퇴</button>
