...
<script>
$(function(){
	$(".gnb:nth-child(2)").addClass("active");
	$(".gnb:nth-child(2) .lnb:nth-child(4)").addClass("active"); 
});	
</script>
</head>
<body>
...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<!-- 서브 비주얼 시작-->
		<div id="sub-visual" data-menu="퀵 임플란트" data-menu-second="자외선 임플란트">
			<div class="inner">
				<a href="${pageContext.request.contextPath}/menu02_03" class="prev-page"></a>
				<h2>자외선 임플란트</h2>
				<a href="${pageContext.request.contextPath}/menu02_05" class="next-page"></a>
			</div>
		</div>
		<!-- 서브 비주얼 끝 -->
		...
		<div id="breadcrumb">
			<div class="inner">
				<ul>
					...
					<!-- 2차 -->
					<li>
						<button>자외선 임플란트</button>
					</li>
				</ul>
			</div>
		</div>
		<!-- BreadCrumb 끝 -->
		<div class="pcode49601">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/496_img_01.png" alt="">
			</div>
		</div>
		
		<div class="pcode49602">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/496_bg_02.png" alt="" usemap="#pcode49602">
				<map name="pcode49602">
				  <area shape="rect" coords="892,101,960,169" href="javascript:void(0);" class="pop" rel="media-popup10">
				</map>
			</div>
		</div>
		
		<div class="pcode49603">
			<div class="inner">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/496_img_03.png" alt="">
			</div>
		</div>
		
		<div class="pcode49604">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/496_img_04.png" alt="">
			</div>
		</div>
		
		
		
		<div class="pcode49606">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/496_img_06.png" alt="">
			</div>
		</div>
		<div class="pcode49607">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/496_img_07.png" alt="">
			</div>
		</div>
		<!-- 세렉 -->
		<div class="pcode49508">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/495_bg_08.png" alt="" usemap="#pcode49508">
				<map name="pcode49508">
				  <area shape="rect" coords="429,106,481,158" href="javascript:void(0);" class="pop" rel="media-popup03">
				</map>
		...
		<!-- 청정구역 -->
		<div class="pcode49605">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/496_img_05.png" alt="">
			</div>
		</div>
		...
		<div class="pcode48306">
			<ul class="inner">
				...
				<li>
					<a href="/html/?pCode=496"><img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/483_icon_03.png" alt=""></a>
					<span>자세히보기 +</span>
				</li>
				<li>
