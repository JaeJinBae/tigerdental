...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<!-- privacy -->
		<form name="inquire" id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/menu06_05write" autocomplete="off">
				...
				<div class="inner">
					<table class="board-cousel-form">
						...
						<tbody>
							...
							<tr>
								<th scope="row">이름</th>
								<td><input type="text" name="name" id="name" class="default" valid="required" element-name="이름" value=""></td>
							</tr>		
							<tr>
							...
							<tr>
								<th>제목</th>
								<td><input type="text" name="title" id="title" maxlength="200" valid="required" element-name="제목" value=""></td>
							</tr>
							<tr>
								<th>연락처</th>
								<td>
							...
							<tr>
								<th>내용</th>
								<td>
									<textarea name="content" id="content" valid="required" element-name="내용"></textarea>
								</td>
							</tr>
							<tr>
			...
			기간 동안 보존합니다. - 보존 이유 : 회원님의 동의를 통한 정보 유지 - 보존 기간 : 회원정보 삭제 요청 시까지</textarea>
					...
					<div class="btn-group-right">
						<div class="inner">
							<div class="brick">
								...
								<button type="submit" class="btn btn-cancel" onclick="location.href='${pageContext.request.contextPath}/menu06_05write'">취소</button>
					...
					<%-- <script type="text/javascript" src="${pageContext.request.contextPath}/resources/lib/js/board.js"></script> --%>
