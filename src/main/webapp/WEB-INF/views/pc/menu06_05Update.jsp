...
function deleteUploadImg(no, type){
	...
	$.ajax({
		url:"${pageContext.request.contextPath}/menu06_05uploadImgDelete",
		type:"post",
...
$(function(){
	...
	$("#phone3").val(p_all[2]);
	var at = $("#at").val();
	$("#i_kind > option[value='"+at+"']").prop("selected", true);
...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="커뮤니티" data-menu-second="온라인 상담">
			<div class="inner">
				<a href="${pageContext.request.contextPath}/menu06_04" class="prev-page"></a>
				<h2>온라인 상담</h2>
				<a href="${pageContext.request.contextPath}/menu06_01" class="next-page"></a>
			</div>
		</div>
		<!-- 서브 비주얼 끝 -->
		
		<!-- privacy -->
		<input type="hidden" id="at" value="${item.advice_type}">
		<form name="inquire" id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/menu06_05update${pageMaker.makeSearch(pageMaker.cri.page)}" autocomplete="off">
			...
			<!-- 게시판 타이틀 시작 -->
			<div class="member-title">온라인 상담</div>
			<!-- 게시판 타이틀 끝 -->
			...
			<div id="jack-board">
				<div class="inner">
					<table class="board-cousel-form">
						...
						<tr>
							<th scope="row">이름</th>
							<td><input type="text" name="name" id="name" class="default" valid="required" element-name="이름" value="${item.name}"></td>
						</tr>
						<tr>
							<th>제목</th>
							<td>
								<input type="text" name="title" id="title" maxlength="200" valid="required" element-name="제목" value="${item.title}">
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								...
								<input type="text" name="i_phone2" id="phone2" maxlength="4" valid="required,phone_tel34" element-name="연락처" value="3333" class="small" autocomplete="off"> -
								<input type="text" name="i_phone3" id="phone3" maxlength="4" valid="required,phone_tel44" element-name="연락처" value="4444" class="small" autocomplete="off">
					...
					<div class="btn-group-right">
						<div class="inner">
							<div class="brick">
								<a href="${pageContext.request.contextPath}/menu06_05" class="btn btn-cancel">목록으로</a>
								<button type="submit" class="btn btn-cancel" onclick="location.href='${pageContext.request.contextPath}/menu06_05'">취소</button>
								<input type="submit" class="btn btn-list" style="width:100px;height:36px;line-height:36px;cursor:pointer;" value="확인">
							</div>
						</div>
					</div>
					<!-- 게시판 버튼 끝 -->
