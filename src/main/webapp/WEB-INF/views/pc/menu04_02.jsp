...
$(function(){
	...
	$(".gnb:nth-child(4) .lnb:nth-child(2)").addClass("active"); 
});	
</script>
</head>
<body>
...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="breadcrumb">
			<div class="inner">
				<ul>
					...
					<!-- 2차 -->
					<li>
						<button>퀵 디지털 교정</button>
					</li>
				</ul>
			</div>
		</div>
		<!-- BreadCrumb 끝 -->
		<div class="pcode52001">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/520_img_01.png" alt="">
			</div>
		</div>
		
		<div class="pcode52002">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/520_img_02.png" alt="">
			</div>
		</div>
		
		<div class="pcode52003">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/520_img_03.png" alt="" usemap="#pcode52003">
				<map name="pcode52003">
				  <area shape="rect" coords="439,205,509,276" href="javascript:void(0);" class="pop" rel="media-popup07">
				</map>
			</div>
		</div>
		
		<div class="pcode52004">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/520_img_04.png" alt="">
			</div>
		</div>
		
		<div class="pcode52005">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/520_img_05.png" alt="">
			</div>
		</div>
		
		<div class="pcode52006">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/520_img_06.png" alt="">
			</div>
		</div>
		
		<div class="pcode52007">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/520_img_07.png" alt="">
			</div>
		</div>
		
		<div class="pcode52008">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/520_img_08.png" alt="">
			</div>
		</div>
		...
		<!-- <div class='pcode48306'>
			<ul class='inner'>
				<li>
					<a href="/html/?pCode=494"><img src='/assets/img/web/sub/theme/483_icon_01.png' alt=''/></a>
					<span>자세히보기 +</span>
				</li>
				<li>
					<a href="/html/?pCode=495"><img src='/assets/img/web/sub/theme/483_icon_02.png' alt=''/></a>
					<span>자세히보기 +</span>
				</li>
				<li>
					<a href="/html/?pCode=520"><img src='/assets/img/web/sub/theme/483_icon_03.png' alt=''/></a>
					<span>자세히보기 +</span>
				</li>
				<li>
					<a href="/html/?pCode=497"><img src='/assets/img/web/sub/theme/483_icon_04.png' alt=''/></a>
					<span>자세히보기 +</span>
				</li>
			</ul>
		</div>
