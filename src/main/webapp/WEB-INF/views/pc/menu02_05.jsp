...
$(function(){
	...
	$(".gnb:nth-child(2) .lnb:nth-child(5)").addClass("active"); 
});	
</script>
</head>
<body>
...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="퀵 임플란트" data-menu-second="1DAY 임플란트">
			<div class="inner">
				<a href="${pageContext.request.contextPath}/menu02_04" class="prev-page"></a>
				<h2>1DAY 임플란트</h2>
				<a href="${pageContext.request.contextPath}/menu02_01" class="next-page"></a>
			</div>
		</div>
		<!-- 서브 비주얼 끝 -->
		...
		<div class="pcode49501">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/495_img_01.png" alt="">
			</div>
		</div>
		
		<div class="pcode49502">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/495_img_02.png" alt="">
			</div>
		</div>
		
		<div class="pcode49503">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/495_img_03.png" alt="">
			</div>
		</div>
		
		<div class="pcode49504">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/495_img_04.png" alt="">
			</div>
		</div>
		
		<div class="pcode49505">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/495_img_05.png" alt="">
			</div>
		</div>
		<div class="pcode49506">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/495_img_06.png" alt="">
			</div>
		</div>
		<div class="pcode49507">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/495_img_07.png" alt="">
			</div>
		</div>
		...
		<div class="pcode49509">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/495_img_09.png" alt="">
			</div>
		</div>
