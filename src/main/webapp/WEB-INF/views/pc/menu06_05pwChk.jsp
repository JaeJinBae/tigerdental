...
function pwChk(info){
	$.ajax({
		url:"${pageContext.request.contextPath}/menu06_05pwChk",
		type:"POST",
		...
		success:function(json){
			if(json == "ok"){
				...
				location.href="${pageContext.request.contextPath}/menu06_05read?"+link[0]+"&"+link[1]+"&"+link[2]+"&keyword="+keyword+"&"+link[4];
			}else{
		...
		<form name="inquire" id="inquire" method="post" action="" onsubmit="return false">
			...
			<div class="check-password">
				...
				<div class="btn-group-center">
					<div class="inner">
						<button type="button" class="btn btn-submit" style="float:none;">확인</button>
						<button type="button" class="btn btn-cancel" style="float:none;" onclick="history.go('-1')">취소</button>
					</div>
				</div>
				<!-- 게시판 버튼 끝 -->
			</div>
