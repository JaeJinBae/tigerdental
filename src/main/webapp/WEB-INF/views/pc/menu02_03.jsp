...
$(function(){
	...
	$(".gnb:nth-child(2) .lnb:nth-child(3)").addClass("active"); 
});	
</script>
</head>
<body>
...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="퀵 임플란트" data-menu-second="3D 네비게이션 임플란트">
			<div class="inner">
				<a href="${pageContext.request.contextPath}/menu02_02" class="prev-page"></a>
				<h2>3D 네비게이션 임플란트</h2>
				<a href="${pageContext.request.contextPath}/menu02_04" class="next-page"></a>
			</div>
		</div>
		<!-- 서브 비주얼 끝 -->
		...
		<div class="pcode49702">
			<div class="full">
				...
				<map name="pcode49702">
				  <area shape="rect" coords="1224,138,1320,232" href="javascript:void(0);" class="pop" rel="media-popup06">
				</map>
			</div>
		</div>
