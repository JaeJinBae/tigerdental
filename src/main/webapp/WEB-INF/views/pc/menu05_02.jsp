...
$(function(){
	...
	$(".gnb:nth-child(5) .lnb:nth-child(2)").addClass("active"); 
});	
</script>
</head>
<body>
...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="예방·일반진료" data-menu-second="OBD진단(치주질환 세균분석)">
			<div class="inner">
				<a href="${pageContext.request.contextPath}/menu05_01" class="prev-page"></a>
				<h2>OBD진단(치주질환 세균분석)</h2>
				<a href="${pageContext.request.contextPath}/menu05_03" class="next-page"></a>
			</div>
		</div>
		<!-- 서브 비주얼 끝 -->
