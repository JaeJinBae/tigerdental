...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="타이거치과" data-menu-second="타이거의 특별함">
			<div class="inner">
				<a href="${pageContext.request.contextPath}/menu01_05" class="prev-page"></a>
				<h2>타이거의 특별함</h2>
				<a href="${pageContext.request.contextPath}/menu01_02" class="next-page"></a>
			</div>
		</div>
		<!-- 서브 비주얼 끝 -->
		...
		<div class="pcode48903">
			<div class="full">
				...
				<map name="pcode48903">
				  <area shape="rect" coords="1217,130,1348,258" href="javascript:void(0);" class="pop" rel="media-popup04">
				  <area shape="rect" coords="815,268,1054,325" href="javascript:void(0);" class="pop" rel="media-popup04">
				</map>
			</div>
		</div>
