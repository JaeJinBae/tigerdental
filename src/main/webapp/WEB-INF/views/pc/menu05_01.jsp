...
$(function(){
	...
	$(".gnb:nth-child(5) .lnb:nth-child(1)").addClass("active"); 
});	
</script>
</head>
<body>
...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="sub-visual" data-menu="예방·일반진료" data-menu-second="아프지 않은 스케일링">
			<div class="inner">
				<a href="${pageContext.request.contextPath}/menu05_05" class="prev-page"></a>
				<h2>아프지 않은 스케일링</h2>
				<a href="${pageContext.request.contextPath}/menu05_02" class="next-page"></a>
			</div>
		</div>
		<!-- 서브 비주얼 끝 -->
		...
		<div class="pcode50901">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/509_img_01.png" alt="">
			</div>
		</div>
		
		<div class="pcode50902">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/509_img_02.png" alt="">
			</div>
		</div>
		
		<div class="pcode50903">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/509_img_03.png" alt="">
			</div>
		</div>
		
		<div class="pcode50904">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/509_img_04.png" alt="">
			</div>
		</div>
		
		<div class="pcode50905">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/web/sub/theme/509_img_05.png" alt="">
			</div>
		</div>
