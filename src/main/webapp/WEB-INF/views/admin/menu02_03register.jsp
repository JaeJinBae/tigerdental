	...
	<div id="container">
		...
		<div id="admin_right">
			...
			<div class="main_bottom_area">
				<form id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/menu02_03register${pageMaker.makeSearch(pageMaker.cri.page)}">
					...
					<div class="write_area">
						...
						<div class="btn_area">
							...
							<p class="btn_right">
								...
								<button type="button" class="btn_gray" onclick="location.href='${pageContext.request.contextPath}/admin/menu02_03register'">취소</button>
							</p>
						</div><!-- btn_area end -->
					</div><!-- write_area end -->
				</form>
