			...
			<div class="main_bottom_area">
				<div class="write_area">
					...
					<div class="btn_area">
						...
						<p class="btn_right">
							<button type="button" class="btn_red" onclick="location.href='${pageContext.request.contextPath}/admin/menu04_02delete/${item.no}'">삭제</button>&nbsp;
							<button type="button" class="btn_gray" onclick="location.href='${pageContext.request.contextPath}/admin/menu04_02withdraw/${item.no}/x'">탈퇴취소</button> 
						</p>
					</div>
