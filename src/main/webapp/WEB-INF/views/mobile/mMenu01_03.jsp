...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="sub-contents pCode-491-01">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/491_img_01.png" alt="" usemap="#pcode49101">
			</div>
		</div>
		<div class="sub-contents pCode-491-02">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/491_img_02.png" alt="" usemap="#pcode49102">
			</div>
		</div>
		<div class="sub-contents pCode-491-03">
			<div class="full">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/491_img_03.png" alt="" usemap="#pcode49103">
			</div>
		</div>
