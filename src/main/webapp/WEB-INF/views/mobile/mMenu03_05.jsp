	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="pcode52601">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/526_img_01.png" alt="">
			</div>
		</div>
		
		<div class="pcode52602">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/526_img_02.png" alt="">
			</div>
		</div>
		
		<div class="pcode52603">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/526_img_03.png" alt="">
			</div>
		</div>
		
		<div class="pcode52604">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/526_img_04.png" alt="">
			</div>
		</div>
		
		<div class="pcode52605">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/526_img_05.png" alt="">
			</div>
		</div>
