...
<div class="quick-counsel-button">
	<button class="toggle-button trn"><img src="${pageContext.request.contextPath}/resources/img/common/theme/quick.png" alt="빠른상담신청"></button>
</div>
<!-- 빠른상담 신청하기 퀵버튼 끝 -->
...
function land_callback(){
	$.post("/m/quick_counsel_proc.php", $("#land").serialize(), function(data){
		alert("상담신청이 완료되었습니다.\n\n고객님의 소중한 정보는 상담에만 이용됩니다.\n\n빠른시일내에 답변드리겠습니다. 감사합니다");
		land_it('reset');
	});
}
