...
$(function(){
	...
	$(".btn-submit").click(function(){
		...
		var info = {"name":name, "id":id, "pw":pw, "phone":phone, "gender":gender, "email":email, "addr":addr, "regdate":regdate, "birth":birth};
		userRegister(info);
	});
});	
</script>
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="join-form">
			<ul class="inner">
				...
				<li>
					...
					<form name="member" id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/m/join">
						...
						<ul class="join-form">
							...
							<li>
								...
								<p class="radio"><input type="radio" name="m_solar" id="m_solar1" value="1" valid="required" element-name="양력음력"> <label for="m_solar1"><i></i>양력</label>&nbsp;&nbsp;&nbsp;
								<input type="radio" name="m_solar" id="m_solar2" value="2" valid="required" element-name="양력음력"> <label for="m_solar2"><i></i>음력</label>&nbsp;&nbsp;&nbsp;</p>
							</li>
							<li>
		...
		<div class="btn-group-center">
			<div class="brick">
				...
				<button type="button" class="btn btn-cancel" onclick="location.href='${pageContext.request.contextPath}/m/join'">취소</button>
			</div>
		</div>
		<!-- 게시판 버튼 끝 -->
