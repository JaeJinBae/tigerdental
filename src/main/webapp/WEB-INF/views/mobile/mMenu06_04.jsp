...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<!-- 서브 비주얼 시작-->
		<div id="sub-visual" data-menu="커뮤니티" data-menu-second="치료후기">
			<div class="inner">
				<h2>치료후기</h2>
			</div>
		</div>
