...
$(function(){
	...
	var birthArr = "${item.birth}".split("-");
	var prev_birth1 = birthArr[0];
	var prev_birth2 = Number(birthArr[1]);
	var prev_birth3 = Number(birthArr[2]);
	$("#birth_year > option[value='"+prev_birth1+"']").prop("selected", true);
	$("#birth_month > option[value='"+prev_birth2+"']").prop("selected", true);
	$("#birth_date > option[value='"+prev_birth3+"']").prop("selected", true);
	...
	$(".btn-submit").click(function(){
		...
		var info = {"no":no, "name":name, "new_pw":new_pw, "phone":phone, "gender":gender, "email":email, "birth":birth, "addr":addr};
		userUpdate(info);
	});
	...
	<div id="sub-container">	
				...
				<li>
					<form name="member" id="member" method="post" enctype="multipart/form-data" action="">
						...
						<ul class="join-form">
							...
							<li>
								<label for="birth_year">생년월일 <i class='star'>*</i></label>
								<select name='birth_year' id='birth_year' title='년' valid='required' element-name='생년월일' class='w60 h30 selectbox' >
								...
								<i>년</i>
								<select name='birth_month' id='birth_month' title='월' valid='required' element-name='생년월일' class='w60 h30 selectbox' >
								...
								<i>월</i>
								<select name='birth_date' id='birth_date' title='일' valid='required' element-name='생년월일' class='w60 h30 selectbox' >
									<option value="">선택</option>
							...
							<li>
								...
								<p class="radio">
									<input type="radio" name="m_solar" id="m_solar1" value="1" checked="checked" valid="required" element-name="양력음력"> <label for="m_solar1"><i></i>양력</label>&nbsp;&nbsp;&nbsp;
									<input type="radio" name="m_solar" id="m_solar2" value="2" valid="required" element-name="양력음력"> <label for="m_solar2"><i></i>음력</label>&nbsp;&nbsp;&nbsp;
								</p>
							</li>
							<li>
								<label for="m_sex1">성별 <i class="star">*</i></label>
								<p class="radio">
									<input type="radio" name="m_sex" id="m_sex1" value="M" checked="checked" valid="required" element-name="성별"> <label for="m_sex1"><i></i>남자</label>&nbsp;&nbsp;&nbsp;
									<input type="radio" name="m_sex" id="m_sex2" value="F" valid="required" element-name="성별"> <label for="m_sex2"><i></i>여자</label>&nbsp;&nbsp;&nbsp;
								</p>
							</li>
							<li>
								<label for="phone1">휴대폰 <i class="star">*</i></label>
								<select name="phone1" id="phone1" title="휴대전화의 국번">
		...
		<div class="btn-group-center">
			<div class="brick">
				...
				<!--<button type="button" class="btn btn-cancel" onclick="location.href='/m-leave';">회원탈퇴</button>-->
				<button type="button" class="btn btn-cancel" onclick="${pageContext.request.contextPath}/">취소</button>
			</div>
		</div>
		<!-- 게시판 버튼 종료 -->
