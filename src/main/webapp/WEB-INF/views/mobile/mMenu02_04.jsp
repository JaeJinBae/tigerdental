	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="pcode49601">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/496_img_01.png" alt="">
			</div>
		</div>
		
		<div class="pcode49602">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/496_img_02.png" alt="" usemap="#pcode49602">
				<map name="pcode49602">
				  <area shape="rect" coords="44,294,400,533" href="javascript:void(0);" class="pop" rel="media-popup10">
				</map>
			</div>
		</div>
		...
		<div class="pcode49603">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/496_img_03.png" alt="">
			</div>
		</div>
		...
		<div class="pcode49605">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/496_img_05.png" alt="">
			</div>
		</div>
		
		<div class="pcode49606">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/496_img_06.png" alt="">
			</div>
		</div>
		<!-- 세렉 -->
		...
		<div class="pcode48908">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_add.png" alt="">
			</div>
		</div>
		...
		<div class="pcode49604">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/496_img_04.png" alt="">
			</div>
		</div>
		<!-- 추가 -->
		<div class="pcode48908">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_case.png" alt="">
			</div>
		</div>
