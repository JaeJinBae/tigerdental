	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="pcode49701">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/497_img_01.png" alt="">
			</div>
		</div>
		...
		<div class="pcode49703">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/497_img_03.png" alt="">
			</div>
		</div>
		
		<div class="pcode49705">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/497_img_05.png" alt="">
			</div>
		</div>
		<!-- 세렉 -->
