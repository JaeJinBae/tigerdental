	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div class="pcode51301">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/513_img_01.png" alt="">
			</div>
		</div>
		
		<div class="pcode51302">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/513_img_02.png" alt="">
			</div>
		</div>
		
		<div class="pcode51303">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/513_img_03.png" alt="">
			</div>
		</div>
		
		<div class="pcode51304">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/513_img_04.png" alt="">
			</div>
		</div>
		
		<div class="pcode51305">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/513_img_05.png" alt="">
			</div>
		</div>
		
		<div class="pcode51306">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/513_img_06.png" alt="">
			</div>
		</div>
		
		<div class="pcode51307">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/513_img_07.png" alt="">
			</div>
		</div>
		
		<div class="pcode51308">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/513_img_08.png" alt="">
			</div>
		</div>
