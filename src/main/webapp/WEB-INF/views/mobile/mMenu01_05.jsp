		...
		<div class="pcode49301">
			<div class="inner">
				<div class="tiger-map">
					...
					<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/493_img_01.png" alt="" usemap="#tiger-map"/>
		
					<map name="tiger-map">
						<area shape="rect" coords="113,406,304,470" href="http://naver.me/xy9QyLaQ" target="_blnak">
						<area shape="rect" coords="337,406,528,470" href="http://map.daum.net/?urlX=505176&urlY=1116068&itemId=889359777" target="_blnak">
					</map>
				</div>
			</div>
		</div>
