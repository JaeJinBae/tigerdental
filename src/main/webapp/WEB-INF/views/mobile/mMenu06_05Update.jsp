...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<form name="inquire" id="form1" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/m/menu06_05update${pageMaker.makeSearch(pageMaker.cri.page)}" autocomplete="off">
			...
			<div class="full">
				<table class="board-cousel-form">
					...
					<tbody>
						...
						<tr>
							<th scope="row">이름</th>
							<td><input type="text" name="i_name" id="i_name" class="default" valid="required" element-name="이름" value="${item.name}"></td>
						</tr>
						<tr>
							<th>제목</th>
							<td>
								<input type="text" name="i_title" id="i_title" maxlength="200" valid="required" element-name="제목" value="${item.title}">
							</td>
						</tr>
						<tr>
							<th>연락처</th>
							<td>
								...
								<input type="text" name="i_phone2" id="phone2" maxlength="4" valid="required,phone_tel34" element-name="연락처" value="3333" autocomplete="off"> -
								<input type="text" name="i_phone3" id="phone3" maxlength="4" valid="required,phone_tel44" element-name="연락처" value="4444" autocomplete="off"><br><br>
			...
			기간 동안 보존합니다. - 보존 이유 : 회원님의 동의를 통한 정보 유지 - 보존 기간 : 회원정보 삭제 요청 시까지</textarea>
				...
				<div class="btn-group-center">
					<div class="brick">
						<button type="button" class="btn btn-submit">글쓰기</button>
						<button type="button" class="btn btn-cancel" onclick="location.href='${pageContext.request.contextPath}/m/menu06_05'">취소</button>
					</div>
				</div>
				<!-- 게시판 버튼 끝 -->
