...
function pwChk(info){
	$.ajax({
		url:"${pageContext.request.contextPath}/m/menu06_05pwChk",
		type:"POST",
		...
		success:function(json){
			if(json == "ok"){
				...
				location.href="${pageContext.request.contextPath}/m/menu06_05read?"+link[0]+"&"+link[1]+"&"+link[2]+"&keyword="+keyword+"&"+link[4];
			}else{
