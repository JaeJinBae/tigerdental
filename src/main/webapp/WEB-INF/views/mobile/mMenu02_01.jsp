...
<div id="wrap">
	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<!-- 서브 비주얼 시작-->
		<div id="sub-visual" data-menu="퀵 임플란트" data-menu-second="임플란트 차별성">
			<div class="inner">
				<h2>임플란트 차별성</h2>
			</div>
		</div>
		...
		<div class="pcode48301">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/483_img_01.png" alt="" usemap="#pcode48301">
				<map name="pcode48301">
				  <area shape="rect" coords="264,843,374,983" href="javascript:void(0);" class="pop" rel="media-popup06">
				</map>
			</div>
		</div>
		
		<div class="pcode48302">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/483_img_02.png" alt="">
			</div>
		</div>
		
		
		<div class="pcode48303">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/483_img_03.png" alt="">
			</div>
		</div>
		
		
		<div class="pcode48304">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/483_img_04.png" alt="">
			</div>
		</div>
		
		<div class="pcode48304">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/483_img_11.png" alt="">
			</div>
		</div>
		
		
		<div class="pcode48305">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/483_img_05.png" alt="" usemap="#pcode48305">
				<map name="pcode48305">
				  <area shape="rect" coords="20,758,618,1128" href="javascript:void(0);" class="pop" rel="media-popup03">
				</map>
			</div>
		</div>
		<!-- 추가 -->
