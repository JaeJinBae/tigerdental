	...
	<!--  닫기 [위치 : include_web_footer.html ]  -->
		...
		<div id="breadcrumb">
			<ul class="full">
				...
				<li class="lnb">
					...
					<ul>
						<li><a href="${pageContext.request.contextPath}/m/menu01_01">타이거의 특별함</a></li>
						<li><a href="${pageContext.request.contextPath}/m/menu01_02">의료진 소개</a></li>
						<li><a href="${pageContext.request.contextPath}/m/menu01_03">진료안내</a></li>
						<li><a href="${pageContext.request.contextPath}/m/menu01_04">내부시설</a></li>
						<li><a href="${pageContext.request.contextPath}/m/menu01_05">찾아오시는 길</a></li>
					</ul>
				</li>
			</ul>
		</div>
		...
		<div class="pcode48901">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_01.png" alt="">
			</div>
		</div>
		
		<div class="pcode48902">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_02.png" alt="">
			</div>
		</div>
		...
		<div class="pcode48903">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_03.png" alt="">
			</div>
		</div>
		<!-- 추가 -->
		<div class="pcode48908">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_add2.png" alt="">
			</div>
		</div>
		
		<div class="pcode48904 pop" rel="media-popup04">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_04.png" alt="">
			</div>
		</div>
		
		<div class="pcode48905">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_05.png" alt="">
			</div>
		</div>
		<!-- 추가 -->
		<div class="pcode48908">
		...
		<div class="pcode48906">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_06.png" alt="">
			</div>
		</div>
		
		<div class="pcode48907">
			<div class="automation">
				<img src="${pageContext.request.contextPath}/resources/img/mobile/sub/theme/489_img_07.png" alt="">
			</div>
		</div>
