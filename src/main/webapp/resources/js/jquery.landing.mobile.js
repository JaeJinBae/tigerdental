$(document).ready( function() {
	...
	$('.main-slide > div.inner').slick({
	   ...
	   draggable:false,
	   prevArrow: '<button class="slick-prev03" aria-label="Previous" type="button"><img src="/assets/img/landing/btn_prev.png"/></button>',
	   nextArrow: '<button class="slick-next03" aria-label="Next" type="button"><img src="/assets/img/landing/btn_next.png"/></button>',
	   fade: true
	});
	...
	$('.doctor').slick({
	  ...
	  infinite: true,
	  adaptiveHeight: true,
	  prevArrow: '<button class="slick-prev04" aria-label="Previous" type="button"><img src="/assets/img/landing/m/btn_prev02.png"/></button>',
	  nextArrow: '<button class="slick-next04" aria-label="Next" type="button"><img src="/assets/img/landing/m/btn_next02.png"/></button>'
	});
