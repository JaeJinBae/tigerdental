$(document).ready( function() {
	...
	$('.doctor-list').slick({
	   ...
	   centerMode: true,
	   centerPadding: '50px',
	   prevArrow: '<button class="slick-prev02" aria-label="Previous" type="button"><img src="/assets/img/landing/btn_prev.png"/></button>',
	   nextArrow: '<button class="slick-next02" aria-label="Next" type="button"><img src="/assets/img/landing/btn_next.png"/></button>',
	   pauseOnFocus:false,
	   pauseOnHover:false,
